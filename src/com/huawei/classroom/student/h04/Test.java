...
public class Test {
	...
	public static void main(String[] args) {
		...
		if (Math.abs(area - 6) < 0.001) {
			// 正确
			System.out.println("Triangle1 PASS");
		}
		...
		if (stack.isEmpty()) {
			// 正确
			System.out.println("MyStack1 PASS");
		}
		stack.push(1);
		stack.push(4);
		stack.push(5);
		...
		if (stack.isFull()) {
			// 正确
			System.out.println("MyStack2 PASS");
		}
		if (stack.pop() == 5) {
			// 正确
			System.out.println("MyStack3 PASS");
		}
		if (!stack.isFull()) {
			// 正确
			System.out.println("MyStack4 PASS");
		}
	}
