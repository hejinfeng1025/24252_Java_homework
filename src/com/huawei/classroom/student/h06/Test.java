...
public class Test {
	...
	public static void main(String[] args) {
		...
		dog1.move(3, 3);
		System.out.println(dog1.getstance(rifleSoldier1));
		dog1.attack(rifleSoldier1);
		System.out.println(dog1.getX()+" "+dog1.getY()+" "+rifleSoldier1.getX()+" "+rifleSoldier1.getY());
		System.out.println(rifleSoldier1.getHealth());
